...
===============================================
Requirements for scikit-surgerytf
===============================================

This is the software requirements file for scikit-surgerytf, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerytf does. Each requirement can be matched to a unit test that
